...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView amount, res, infoM, infoC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        infoM = (TextView) findViewById(R.id.infoM);
        infoC = (TextView) findViewById(R.id.infoC);
    ...
    public void onClick(View v) {
        ...
        switch (buttonPresionado){
            case "C":
                amount.setText("0");
                infoM.setText("Moneda");
                infoC.setText("Conversión");
                res.setText("...");
                break;
            case ".":
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String valor = response.getString(divisa);
                    jsonResponse = valor;
                    ...
                    if (divisa.contains("EUR_USD")){
                        res.setText(resultado+" $");
                    }
                    if (divisa.contains("USD_EUR")){
                        res.setText(resultado+" €");
                    }
